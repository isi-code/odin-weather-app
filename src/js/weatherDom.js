export class WeatherAppDom {
    ...
    formSection(){
        const formSectionTemp = {
            ...
            children:[ 
                {tag:'h1', prop:{textContent:"Weather app"}}
            ] 
        }
    ...
    #createForm() {
      const formTemplate = {
        ...
        children:[
            { tag: 'h2', prop:{textContent:"Fill the form to get the weather forecast"} },
            { tag: "label", prop: { textContent: "Location", htmlFor: "place" } },
            { tag: "input", prop: { type: "text", placeholder: "Example: Tijuana", name: "place", id: "place", } },
            { tag: "fieldset", children: [
                { 
                    tag:"div", 
                    prop: { className: "tempMetric" }, 
                    children:[ 
                        { tag:'input', prop: { type: "radio", id: "celsius", name: "tempUnit", value: "metric", checked: true } },
                        { tag: 'label', prop: { textContent: "Celsius (°C)", htmlFor: "celsius" } },
                        { tag:'input', prop: { type: "radio", id: "faren", name: "tempUnit", value: "us" } },
                        { tag: 'label', prop: { textContent: "Farenheit (°F)", htmlFor: "faren" } },
                    ] 
                }
            ]},
            { tag: "button", prop: { textContent: "Search Weather", type: "submit" }}
        ]
      };
            ...
            children:[
                ...
                },
                {
                    ...
                    children:[
                        ...
                        { tag:'small', prop:{textContent: `Feels like ${temp}`, style: "font-style: italic;"} }
                    ]
                },
                {
                    tag:'table',
                    children:[
                        { 
                            ...
                            children:[ 
                                { 
                                    tag:"tr", 
                                    children:[ { tag:'th', prop:{ textContent:"Weather Details", colSpan:2, } } ]
                                }  
                            ]
                        },
                        {
